...
| `--output` / `-o` | Output CSV filename | auto-named from query |
...
python scraper.py -q "apartments Orange County CA" -m 100 -o apartments.csv
...
python batch_scrape.py --max 50 --output all_leads.csv
```
